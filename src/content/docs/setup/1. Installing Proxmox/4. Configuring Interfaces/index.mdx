...
If you want to copy my config look here [/etc/network/interfaces](./etc-network-interfaces/). There you will find my exact config to copy.
Make sure to remember or backup your current values.
You will have to replace the IPv4 and IPv6 address and gateway in my config with your current CSSFontFeatureValuesRule.
